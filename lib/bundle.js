...
/***/ function(module, exports, __webpack_require__) {
	...
	var MP3Player = __webpack_require__(2);
	var Path = __webpack_require__(3);
	var Ship = __webpack_require__(6);
	var Orb = __webpack_require__(7);
	var Explosion = __webpack_require__(9);
	var explosion = null;
	
	var GameControls = __webpack_require__(10);
	...
	window.addEventListener("load", function() {
	  ...
	  var frameLooper = function() {
	    ...
	    if (audio.duration > 0 && !audio.paused) {
	      ...
	      var checkMusic = fbcArray.every(function (num) {
	        return num === 0;
	      });
	
	      var orbMoveHorizontal = Path.boosted || checkMusic;
...
/***/ function(module, exports, __webpack_require__) {
	...
	MP3Player.prototype.setDemoMusic = function() {
	  this.audio.src = "./audio_files/chasing_time.wav";
	  this.track = null;
	  this.set = [];
	};
	...
	MP3Player.prototype.showScore = function() {
	  $(this.audio).on("ended", function() {
	    if (this.currentType === "track" || this.currentType === "demo") {
	...
	MP3Player.prototype.launchDemo = function() {
	  ...
	  this.launch(function() {
	    ...
	    $("#track-name").html("Chasing Time");
	    $("#track-artist").html("Azeailia Banks");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Pulse = __webpack_require__(8);
